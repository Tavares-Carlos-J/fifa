...
const nomesJogadores = {
    ...
    '2': ["O Conceito de Fusão", "A Vontade de Esfolar uma Buceta", "Reprodução Assexuada", "O Crescimento Comicamente Rápido", "O Curso", "O Amor Platônico de forma tão saudável quanto pode ser", "Caos", "O Amor Não Recíproco", "O Medo Constante do Fracasso", "O conceito de tudo ir ou terminar no ICB", "A Morena", "Depressão2", "A ordem dada pela cônjuge", "O verso Perfeito", "Um arrombamento"],
